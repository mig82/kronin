 ...
 kony.sdk.binary.validateUploadParams = function(uploadParams) {
     ...
     if (!kony.sdk.isNullOrUndefined(uploadParams[kony.sdk.constants.FILE_PATH]) && !kony.sdk.isNullOrUndefined(uploadParams[kony.sdk.constants.RAW_BYTES])) {
         kony.sdk.logsdk.error("### kony.sdk.binary.validateUploadParams :: Error: BOTH FilePath and rawBytes are provided - please" + " provide only one of them");
         return kony.sdk.error.getClientErrObj(kony.sdk.errorcodes.invalid_params_instance, "BOTH FilePath and rawBytes are provided " + " " + kony.sdk.errormessages.invalid_params_instance)
     }
     // check if neither are defined
     if (kony.sdk.isNullOrUndefined(uploadParams[kony.sdk.constants.FILE_PATH]) && kony.sdk.isNullOrUndefined(uploadParams[kony.sdk.constants.RAW_BYTES])) {
         kony.sdk.logsdk.error("### kony.sdk.binary.validateUploadParams :: Error: Neither FilePath nor rawBytes is provided - please" + " provide one of them");
         return kony.sdk.error.getClientErrObj(kony.sdk.errorcodes.invalid_params_instance, "Neither FilePath nor rawBytes is provided " + " " + kony.sdk.errormessages.invalid_params_instance);
     }
     ...
     if (!kony.sdk.isNullOrUndefined(uploadParams[kony.sdk.constants.FILE_PATH]) && !kony.sdk.util.isValidString(uploadParams[kony.sdk.constants.FILE_PATH])) {
         ...
         return kony.sdk.error.getClientErrObj(kony.sdk.errorcodes.invalid_params_instance, "Invalid datatype of FilePath " + kony.sdk.util.type(uploadParams[kony.sdk.constants.FILE_PATH]) + " " + kony.sdk.errormessages.invalid_params_instance);
     }
     ...
     if (!kony.sdk.isNullOrUndefined(uploadParams[kony.sdk.constants.RAW_BYTES]) && kony.sdk.util.type(uploadParams[kony.sdk.constants.RAW_BYTES]) !== "kony.types.RawBytes") {
         ...
         return kony.sdk.error.getClientErrObj(kony.sdk.errorcodes.invalid_params_instance, "Invalid datatype of rawBytes " + kony.sdk.util.type(uploadParams[kony.sdk.constants.RAW_BYTES]) + " " + kony.sdk.errormessages.invalid_params_instance);
     }
     return null;
 };
 kony.sdk.binary.getBinaryData = function(inputParams, streaming, downloadConfig, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, downloadFailureCallback, options) {
 ...
 */
 ...
 kony.sdk.KNYObj.getPendingRecordsForUpload = function(knyObj, options, successCallback, failureCallback) {
     ...
     kony.sdk.logsdk.trace(" Entering " + LOG_PREFIX);
     var syncCallback = kony.sdk.OfflineObjects.createSyncCallback("Fetching pending records for upload of object " + knyObj.name + " success", successCallback, "Fetching pending records for upload of object " + knyObj.name + " object failed", failureCallback);
     var sdkObjectSync = knyObj.getSdkObjectSync();
 ...
 kony.sdk.KNYObj.getBinary = function(knyObj, options, fileDownloadStartedCompletionBlock, chunkDownloadCompletedCompletionBlock, streamDownloadCompletionBlock, fileDownloadCompletedCompletionBlock, downloadFailureCompletionBlock) {
     var LOG_PREFIX = "kony.sdk.KNYObj.getBinary";
     kony.sdk.logsdk.trace("Entering " + LOG_PREFIX);
     var binaryCallback = kony.sdk.OfflineObjects.createKonyBinaryDownloadCallback("Get binary on " + knyObj.name + " object started", fileDownloadStartedCompletionBlock, "Get binary on " + knyObj.name + " object: chunk download completed", chunkDownloadCompletedCompletionBlock, "Get binary on " + knyObj.name + " object: stream download completed", streamDownloadCompletionBlock, "Get binary on " + knyObj.name + " object: file download completed", fileDownloadCompletedCompletionBlock, "Get binary on " + knyObj.name + " object failed", downloadFailureCompletionBlock);
     var sdkObjectSync = knyObj.getSdkObjectSync();
     sdkObjectSync.getBinaryDownloadStartedHandlerChunkDownloadCompletedHandlerStreamDownloadCompletedHandlerFileDownloadCompletedHandlerDownloadFailureHandler(options, binaryCallback.onFileDownloadStarted, binaryCallback.onChunkDownloadCompleted, binaryCallback.onStreamDownloadCompleted, binaryCallback.onFileDownloadCompleted, binaryCallback.onDownloadFailure);
 };
 ...
 function konySdkSyncService(konyRef) {
     ...
     this.startReconciliation = function(config) {
         if (!syncServiceHandler.startReconciliation) throw new Exception(kony.sdk.errorConstants.SYNC_FAILURE, "sync provider doesnot support reconciliation");
 ...
 kony.sdk.offline.updateSuccessUserCredentials = function(providerName) {
     ...
     if (tempUserObj != null && tempUserObj != undefined) kony.sdk.dataStore.setItem(getOfflineLoginDBKeyForProvider(providerName), tempUserObj);
